...
from feedzero.feeds.models import EnrichedContent
...
class TestEnricher:
    ...
    def test_enrich_doesnt_run_against_already_enriched(
        ...
        fn = mocker.patch("feedzero.ingest.enricher.base.Enricher.save_to_entry")
        enricher.enrich()
    ...
    def test_enrich_entry(self, mocker, enricher, newspaper_article):
        ...
        html_fn = mocker.patch(
            "feedzero.ingest.enricher.base.Enricher.extract_page_html"
        )
        html_fn.return_value = "html_to_parse"

        article_fn = mocker.patch(
            "feedzero.ingest.enricher.base.convert_html_to_newspaper"
        )
