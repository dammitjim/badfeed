...
urlpatterns = [
    ...
    path(
        "<int:feed_pk>/entries/",
        _views.EntryListByPK.as_view(),
        name="entry_list_by_pk",
    ),
    path(
        "<slug:feed_slug>/entries/",
        _views.EntryListBySlug.as_view(),
        name="entry_list_by_slug",
    ),
    path(
        "<int:feed_pk>/entries/<int:pk>/",
        _views.EntryDetail.as_view(),
        name="entry_detail",
    ),
]
